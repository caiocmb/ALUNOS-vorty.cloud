<div class="row align-items-center mb-5">
                        <div class="col-auto">
                            <span class="avatar avatar-xl rounded-circle avatar-glow" style="background-image: url(https://i.pravatar.cc/150?u=aline)"></span>
                        </div>
                        <div class="col">
                            <h1 class="mb-1 brand-orbitron" style="font-size: 1.5rem;">Olá, Aline!</h1>
                            <div class="d-flex align-items-center gap-2">
                                <span class="status-badge">PLANO ATIVO</span>
                                <span class="text-muted small">ID: #8829</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-cards">
                        ...
                        <div class="col-12 col-md-8">
                            <a href="selecao_treino.php" class="portal-card card-main shimmer">
                        ...
                        <div class="col-12 col-md-4">
                            <a href="ajustes.php" class="portal-card">
                        ...
                        <div class="col-6 col-md-4">
                            <a href="historico.php" class="portal-card">
                        ...
                        <div class="col-6 col-md-4">
                            <a href="financeiro.php" class="portal-card">
                                ...
                                <h3 class="card-title mt-2">Financeiro</h3>
                            </a>
                        </div>
